...
| `DATABASE_URL` | Full PostgreSQL connection string. If set, the app can derive DB host, port, name, user, and password from it. | `postgresql://postgres:postgres@localhost:5432/hackathon_db` |
